    ...
    <div className="billing-page">
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '2.5rem', flexWrap: 'wrap', gap: '1rem' }}>
        <div style={{ flex: '1', minWidth: '280px' }}>
          ...
          <p style={{ color: 'var(--on-surface-variant)' }}>{currentUser.es_administrador ? 'Valida transferencias y carga comprobantes oficiales.' : 'Historial y reporte de transferencias.'}</p>
        </div>
                    ...
                    <td style={{ padding: '12px' }}>
                      <div style={{ display: 'flex', gap: '10px' }}>
                        ...
                        <label style={{ cursor: 'pointer', padding: '4px 8px', backgroundColor: 'var(--primary)', color: 'white', borderRadius: '4px', fontSize: '0.75rem', display: 'flex', alignItems: 'center', gap: '4px' }}>
                          <Plus size={14} /> Comprobante
                          <input type="file" style={{ display: 'none' }} onChange={(e) => handleFileUpload(e, 'comprobante', p.id, p.socio_id)} />
                        </label>
                      </div>
                    </td>
                  )}
