...
const rawUrl = isLocalhost ? `${window.location.origin}/directus-proxy` : (import.meta.env.VITE_DIRECTUS_URL || 'https://xer.pascalito.com.ar');
export const DIRECTUS_URL = rawUrl.replace(/\/+$/, '') + '/';
